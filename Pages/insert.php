...
<html lang="en">
  ...
  <body>
    <?php 
      ...
      include_once("../View/InsertView.php");
      addNavbar();
    ?>
    <div id='usermenu'>
      <ul>
    ...
    <section class="edit">
        <div class="content">
            <?php 
              insertData($_GET['table']);
              if(isset($_SESSION['insertCarsError']))
              {
                echo $_SESSION['insertCarsError'];
              } 
              if(isset($_SESSION['insertDriversError']))
              {
                echo $_SESSION['insertDriversError'];
              } 
            ?>
        </div>
    </section>
